namespace Fuse.API.Controllers
{
    ...
    public class EnvironmentController : ControllerBase
    {
        ...
        public async Task<ActionResult<EnvironmentInfo>> UpdateEnvironment([FromBody] UpdateEnvironment command)
        {
        ...
        [ProducesResponseType(404)]
        public async Task<IActionResult> DeleteEnvironment([FromRoute] DeleteEnvironment command)
        {
